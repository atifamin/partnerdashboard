...
(1, ' - New Deal', '', 1, '2019-07-03 11:22:04', NULL, NULL, 33, 1, 0, 0, '', 0, NULL, NULL, '0', 0),
(2, ' - New Deal', '', 1, '2019-07-03 11:23:21', NULL, NULL, 33, 2, 0, 0, '', 0, NULL, NULL, '0', 0),
(3, 'as dfasd fd - New Deal', '', 1, '2019-07-03 11:40:28', NULL, NULL, 33, 3, 0, 0, '', 0, NULL, NULL, '0', 0),
(4, 'asd fasd fsd - New Deal', '', 1, '2019-07-03 11:41:35', NULL, NULL, 33, 4, 0, 0, '', 0, NULL, NULL, '0', 0),
(5, 'test - New Deal', '', 1, '2019-07-03 12:21:28', NULL, NULL, 33, 5, 3434, 0, '', 0, NULL, NULL, '0', 0);
...
INSERT INTO `tasks_todo` (`id`, `task_id`, `title`, `status`) VALUES
(1, 74, 'some todo', 0);
...
CREATE TABLE `task_comment` (
  ...
  `task_comment_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `task_comment_title` varchar(128) NOT NULL,
  `task_comment_message` varchar(2048) NOT NULL,
  `task_comment_is_attach` int(11) NOT NULL,
  `task_comment_file_fullname` varchar(500) NOT NULL,
  `task_comment_file_name` varchar(500) DEFAULT NULL,
  `task_comment_file_type` varchar(500) DEFAULT NULL,
  `task_comment_file_path` longtext,
  `task_comment_full_path` longtext,
  `task_comment_file_extension` varchar(50) DEFAULT NULL,
  `task_comment_file_size` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `task_comment` (`task_comment_id`, `task_comment_task_id`, `task_comment_user_id`, `task_comment_date`, `task_comment_title`, `task_comment_message`, `task_comment_is_attach`, `task_comment_file_fullname`, `task_comment_file_name`, `task_comment_file_type`, `task_comment_file_path`, `task_comment_full_path`, `task_comment_file_extension`, `task_comment_file_size`) VALUES
(20, 56, 1, '2019-06-19 10:52:03', 'comment title', 'comment testing comment testing comment testing comment testing comment testing comment testing comment testing comment testing comment testing comment testing ', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(21, 56, 1, '2019-06-19 10:53:02', 'Testing On reply', '@Atif One Hello Testing On Reply', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(23, 95, 1, '2019-06-19 17:39:31', 'testing T', 'Testing C', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(25, 95, 1, '2019-06-19 17:39:53', 'testing reply', '@Admin One Testing reply', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(27, 87, 1, '2019-06-19 17:41:32', 'test', 'testing test', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(29, 87, 1, '2019-06-19 18:19:05', 'test comment -- atif 1', 'comment description', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(31, 87, 1, '2019-06-19 18:19:23', 'test comment 2 -- atif', 'test comments 2', 1, '1.jpg', '1560968363_1.jpg', 'image/jpeg', 'uploads/', 'uploads/1560968363_1.jpg', 'jpg', '72397'),
(33, 91, 1, '2019-06-20 05:01:22', 'Test User Comment Title', 'This is a test comment from Test User', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(35, 95, 1, '2019-06-22 15:51:25', 'jksdlaf', 'kjfsdlfg', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(37, 95, 1, '2019-06-24 17:23:47', 'Title', 'Test', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(39, 95, 1, '2019-06-24 17:24:36', 'Reply Text', '@Test User \r\nthis reply text is used for testing', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(41, 87, 1, '2019-06-26 13:34:56', 'Testing Comment Reply Comment', 'Testing Comment Reply Comment', 1, 'Comparison-City-MAIN-ART.jpg', '1561556096_Comparison-City-MAIN-ART.jpg', 'image/jpeg', 'uploads/', 'uploads/1561556096_Comparison-City-MAIN-ART.jpg', 'jpg', '670728'),
(43, 87, 1, '2019-06-26 13:38:47', 'new', 'new', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(45, 87, 1, '2019-06-26 13:39:19', 'a', 'a', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(47, 87, 1, '2019-06-26 13:40:32', 'new', 'new', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(49, 87, 1, '2019-06-26 13:52:53', 'Hello', 'Hello', 0, '', NULL, NULL, NULL, NULL, NULL, NULL),
(51, 87, 1, '2019-06-26 14:32:42', 'testing2', 'hello2', 0, '', NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Dumping data for table `task_comment_reply`
--

INSERT INTO `task_comment_reply` (`id`, `commentId`, `replyId`) VALUES
(17, 41, 31),
(19, 47, 41),
(21, 49, 41),
(23, 51, 49);
...
(102, 64, '2016-11-02 20:35:31', '2016-11-02 20:35:37', 1),
...
(107, 93, '2019-06-19 12:20:30', '2019-06-19 12:20:31', 1),
(109, 95, '2019-06-26 04:15:32', '2019-06-26 04:15:34', 1);
...
(1, 5001, 'Admin', 'One', 'atifamin2002@gmail.com', '202cb962ac59075b964b07152d234b70', 0, 0),
(77, 0, 'User', 'One', 'user1@user1.com', '202cb962ac59075b964b07152d234b70', 0, 10),
...
--
ALTER TABLE `task_comment`
  MODIFY `task_comment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `task_periods`
  MODIFY `task_periods_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
