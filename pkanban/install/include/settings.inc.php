<?php
    ...
    define('EI_CONFIG_FILE_PATH', EI_CONFIG_FILE_DIRECTORY."../application/config/".EI_CONFIG_FILE_NAME);
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'pKanban');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'v1.6');
    ...
    define('EI_POST_INSTALLATION_TEXT', 'Great! Your personal kanban board is ready now!');
