...
*/
 ...
 //    }
    ...
    public function request_access_files(){
        ...
        if($personal_data['request_access_length'] != null || $personal_data['request_access_type'] != null) {
            $this->partnerDB->insert('request_access', $personal_data);
        }
    }
