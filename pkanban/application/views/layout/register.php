...
e('Email address', true); ?>"  required autofocus> <input type="password"
name="password" id="inputPassword" class="form-control" value="<?php //echo
$password; ?>"  placeholder="<?php echo e('Password', true); ?>" required
value="admin"> <?php endif; ?>
            ...
            <button class="btn btn-lg btn-primary btn-block btn-signin md-trigger" type="submit"><?php echo e('Login', true); ?></button>
            <a href="<?php echo base_url(); ?>access/register" style="padding: 7px;" class="btn btn-primary btn-block btn-signin" type="submit">Register New Mail</a>
