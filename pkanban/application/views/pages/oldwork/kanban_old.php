    ...
    <?php foreach ($data['containers'] as $container): ?>
        ...
        <div class="column sortable col-md-<?php echo $column_value; ?>" rel="<?php echo $container['container_id']; ?>"
            ...
            <div
                ...
                <?php echo '$'.number_format(get_container_total($container['container_id'])) ; ?>
                ...
                <div class="tab-content bck">
                    <div id="tab_edit" class="tab-pane fade in active">
                        <form class="formAjax" action="<?php echo base_url(); ?>ajax/edit_task/" method="post">
                            ...
                            <div class="form-group to_do">
                                &nbsp;&nbsp;<i class="fa fa-comment-o">&nbsp;&nbsp;&nbsp;&nbsp;</i><label for="Add_comment" class="form-control-label"><?php echo e('Add Comment', true); ?>
                                    </label>
                            <br>
<style type="text/css">
#row1{margin-top: 12px;}
#col1{margin-top: 4px;padding-left: 5px;padding-top: 4px;}    
#col2{margin-top: 8px; padding-left: 60px;} 
.circle{
  height: 30px;
  width: 30px;
  border-style: ;
...
<div class="row" id="row1">
    <div class="col-md-1 circle" id="col1"><?=substr($_SESSION['user_session']['user_name'], 0,1).substr($_SESSION['user_session']['user_last_name'], 0,1); ?></div>
    <div class="col-sm-4" id="col2">
    <label for="Comment_Title" class="form-control-label"><?php echo e('Comment Title', true); ?>:</label> 
    </div>
    <div class="col-sm-7">
    <textarea name="Comment_Title" id="editTodoInput1" class="form-control todoInput" rows="1" placeholder="Comment Title"></textarea> 
    </div>
</div>   <br>                         
 ...
 <!-- <script src="<?php //echo base_url(); ?>ckeditor/ckeditor.js" type="text/javascript"></script> -->
                                    <textarea name="task_comment" id="editTodoInput2" class="task_comment form-control todoInput"
