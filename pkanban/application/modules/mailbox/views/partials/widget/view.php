<div style="padding:10px">
    <div class="inbox-header inbox-view-header">
        ...
        <?php /* <div class="pull-right"><i class="fa fa-print"></i></div> */ ?>
    </div>
                ...
                <?php if (file_exists(($filename = FCPATH . 'uploads/' . $file['mailbox_emails_attachments_file']))): ?>
                    <div class="margin-bottom-25">
                        <?php if (in_array(pathinfo($filename, PATHINFO_EXTENSION), ['jpg', 'png', 'bmp'])): ?>
                            <img src="<?php echo base_url_uploads('uploads/' . $file['mailbox_emails_attachments_file']); ?>">
                        <?php endif; ?>
                        <div>
                            <strong><?php echo $file['mailbox_emails_attachments_name']; ?></strong>
                            <span><?php echo filesize($filename); ?></span>
                            <a href="<?php echo base_url_uploads('uploads/' . $file['mailbox_emails_attachments_file']); ?>" download="<?php echo $file['mailbox_emails_attachments_name']; ?>">Download</a>
                        </div>
                    </div>
                <?php endif; ?>
            <?php endforeach; ?>
