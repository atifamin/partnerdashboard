		...
		<div class="nav-tabs-custom">
		  <div class="row">
		   <div class="col-lg-4" style="margin-top:2%;">
			<ul style="list-style-type:none;margin-left: -30px;" id="myTab31" > 
			...
			<div class="tab-content" style="background:white;min-height:258px;padding:3%;">  
				...
				<div id="<?php echo replace_string(replace_string($Tab2_Q5D['content_code'],'_',' '),'_',','); ?>" class="tab-pane <?php if($Tab2_Index5 == 1){echo 'in active';} ?>">
					...
					<a style="margin-right:12%;" <?php if($Tab2_Q5D['ref_url_target'] == 'BLANK'){echo 'target="_blank"';}?> href="<?php echo $Tab2_Q5D['ref_url']; ?>" class="pull-right moreinfoa">READ MORE</a>
					</div>
				</div>
				<?php $Tab2_Index5++; } ?> 
				 </div>
