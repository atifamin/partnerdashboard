...
if($CertificationID>0){
	$Tab1_Q1 = 'SELECT * FROM `scprs` WHERE `Certification ID`='.$CertificationID.' GROUP BY `Purchase Order ID` ORDER BY scprs_record_id DESC LIMIT 7 OFFSET 1';
}elseif($VendorID>0){
	$Tab1_Q1 = 'SELECT * FROM `scprs` WHERE `Vendor ID`='.$VendorID.' GROUP BY `Purchase Order ID` ORDER BY scprs_record_id DESC LIMIT 7 OFFSET 1';
}
