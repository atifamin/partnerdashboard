<div class="col-sm-12">
							...
							<div class="widget-body">
										<?php
											$Tab2_Q4 = 'SELECT `cfm_id`,`title`,`content_code` FROM `cfm` WHERE `type`="Best Practices" GROUP BY `content_code`';
									...
									<div class="tabbable tabs-left">
										...
										<div class="tab-content no-padding" style="background:#95B3D7;min-height:200px;">  
											<?php
												$Tab2_Q5 = 'SELECT * FROM `cfm` WHERE `type`="Best Practices" GROUP BY `content_code`';
											...
											<div id="<?php echo replace_string(replace_string($Tab2_Q5D['content_code'],'_',' '),'_',','); ?>" class="tab-pane <?php if($Tab2_Index5 == 1){echo 'in active';} ?>">
												...
												<p><?php echo substr($Tab2_Q5D['text'],0,500); ?></p>
