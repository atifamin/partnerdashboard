...
<style>
ul.paging{margin: 0px 0px 3px -13px;padding:24px;padding-bottom:13%;}
...
<div class="widget-body">
	...
	<div class="row" style="background: white;margin-left: 1px;margin-right: 1px;">
		...
		<div class="tab-content" style="background:white;min-height:234px;padding:0%;">  
			...
			<div id="<?php echo replace_string(replace_string($Tab2_Q5D['content_code'],'_',' '),'_',','); ?>" class="tab-pane <?php if($Tab2_Index5 == 1){echo 'in active';} ?>">
				...
				<div class="contentS" style="background:aliceblue;padding:3%;">
				<p style="padding:0px;color:#10253F;background:aliceblue;"><?php echo substr($Tab2_Q5D['text'],0,500); ?></p>
				<a <?php if($Tab2_Q5D['ref_url_target'] == 'BLANK'){echo 'target="_blank"';}?> href="<?php echo $Tab2_Q5D['ref_url']; ?>" style="color:#1f497d;font-size:19px;font-weight:700;" class="pull-right moreinfoa">READ MORE</a>
				</div>
			</div>
			<?php $Tab2_Index5++; } ?> 
			 </div>
