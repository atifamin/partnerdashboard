...
<div class="alert alert-info tab3_boxes" style="float:left;width:100%;margin-top:25px;">
	...
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pull-right">
		<a href="#modal-table" role="button" data-toggle="modal" onclick="showofferboxpopup(<?php echo $OfferData['offer_box_id']; ?>,'<?php echo $PartnerName; ?>')" class="btn btn-sm btn-primary btn-white btn-round tab3btn" type="button" style="margin-top:107px;float:right;">
