...
if($CertificationID>0){
	$Tab1_Q1 = 'SELECT * FROM `scprs` WHERE `Certification ID`='.$CertificationID.' GROUP BY `Purchase Order ID` ORDER BY scprs_record_id DESC';
}elseif($VendorID>0){
	$Tab1_Q1 = 'SELECT * FROM `scprs` WHERE `Vendor ID`='.$VendorID.' GROUP BY `Purchase Order ID` ORDER BY scprs_record_id DESC';
}  
								...
								<div class="col-xs-12 col-sm-12 widget-container-col" style="padding:0px;">
									<div class="widget-box collapsed">
										<div class="widget-header widget-header-large" style="background:#1F497D;color:#fff;">
											<h4 class="widget-title">View other contracts you have recently won</h4>
											<div class="widget-toolbar">
												<a href="#" data-action="collapse">
										...
										<div class="widget-body">
											<div class="widget-main">
												<?php include "scpr_prime_contracts_more.php"; ?>
											</div>
										</div>
									</div>
								</div> 
