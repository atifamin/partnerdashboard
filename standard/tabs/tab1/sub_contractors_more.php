				...
				<div class="widget-main">
					<table class="table table-bordered primetable"> 
						...
						<tbody>
							...
							<td style="width:85px;"><p style="color:#2f64ac;font-size:35px;text-align:center;margin-top:10%;font-weight: 600;">$<?php echo number_format($Tab1_Q1D['award_amount'],0); ?></p></td>
