...
<div class="row">
   ...
   <div class="col-lg-4 col-xs-12" align="center">
   	<div class="div-cont-amount">
   		<span class="container">$757,000</span>
   	</div>
...
?>									
	...
	<div class="row cus-border">
		<div class="col-md-4 text-center">
			<div class="mt-10">
				<span class="font-30 color-1">Contract Financing<br>$5000 - $100,000</span>
			</div>
			<button type="button" class="btn mb-10 mt-10 bg-button"><span class="text-white">Request Financing</span></button>
			<div class="vl"></div>
		</div>
		...
		<div class="col-md-3 text-center">
			<div class="mt-10 mb-10">
				<strong class="color-1 font-25">PRE-PAYMENT<br>PENELTY?</strong><br>
	...
	<div class="row mt-10 cus-border">
		<div class="col-md-4 text-center mt-10 mb-10">
			<div class="col-md-12 mb-10 text-white"><div class="bg-1"><span class="font-20">YOUR bizVAULT Status</span></div></div>
			<div class="col-md-4"><img src="../assets/img/a13.png" width="80"></div>
			<div class="col-md-8"><div class="text-white bg-2"><span>Your bizVAULT Contains All <br>Needed Documents and <br>Files</span></div></div>
			<div class="vl-1"></div>
		</div>
		<!-- <div class="col-md-1">
			<div class="vl"></div>
		...
		<div class="col-md-5 text-center">
			<div class="mt-10">
				<span class="mt-10 font-25 color-3">Contract and Invoice Financing<br>Solutions for your  California<br> Certified Business</span>
			</div>
			<div class="vl"></div>	
		</div>
		<div class="col-md-3 text-center">
		...
		<div class="row mb-10">
			...
			<div class="col-md-6 text-center"><img src="../assets/img/financing-works.jpg" width="80%" class="mt-10">
		</div>
	</div> 
