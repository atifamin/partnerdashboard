...
<div class="row">
  ...
  <div class="form-group col-md-12">
    ...
    <div class="row">
      <div class="col-md-6">
        <input type="text" class="form-control" name="largest_client1" id="largest_client1" required="" value="<?php echo $userDetail->largest_client1; ?>">
        <div class="help-block with-errors"></div>
      </div>
      <div class="col-md-6">
        <input type="text" class="form-control" name="largest_client2" id="largest_client2" required="" value="<?php echo $userDetail->largest_client2; ?>">
        <div class="help-block with-errors"></div>
      </div>
      <div class="col-md-6">
        <input type="text" class="form-control" name="largest_client3" id="largest_client3" required="" value="<?php echo $userDetail->largest_client3; ?>">
        <div class="help-block with-errors"></div>
      </div>
      <div class="col-md-6">
