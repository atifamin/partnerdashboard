...
$Direct = $_POST['direct_login'];
	...
	echo '<div class="alert alert-success alert-dismissible">PLEASE WAIT WHILE WE CONFIGURE YOUR DASHBOARD....</div>';
	}else{
?>
					<input id="userid" class="form-control" value="<?php echo $UserID; ?>" type="hidden">
					<div class="alert alert-danger alert-dismissible">Your eMail OR password is wrong.</div>
