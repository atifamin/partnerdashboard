...
<nav class="navbar navbar-inverse navbar-fixed-top"
     style="display:none; background-color:<?php echo unserialize(NAVBAR_COLORS)[$data['configs']['conf_navbar_color']]; ?>;">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url(); ?>"><?php echo e('pKanban', true); ?></a>
        </div>

        <div id="navbar" class="navbar-collapse collapse" hidden="hidden">
